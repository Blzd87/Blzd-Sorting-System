...
execute as @e[type=item] at @s if block ~ ~-1 ~ minecraft:magma_block if block ~ ~-2 ~ minecraft:iron_block run function bss:sortfarm
...
execute as @e[type=item] at @s if block ~ ~-1 ~ minecraft:magma_block if block ~ ~-2 ~ minecraft:gold_block run function bss:sort